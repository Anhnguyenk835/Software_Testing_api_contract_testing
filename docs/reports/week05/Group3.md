...
- Xây dựng Postman Collection cơ bản thực hiện các thao tác CRUD lên ứng dụng API mẫu.
...
- Thiết kế kịch bản kiểm thử hợp đồng Pact (xác định rõ cấu trúc dữ liệu, kiểu dữ liệu, các trường bắt buộc mà Consumer kỳ vọng ở Provider).
