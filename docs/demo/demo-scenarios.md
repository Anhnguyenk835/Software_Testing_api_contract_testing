...
| 2 | Environment & Variable | Tách biến môi trường (dev/prod), dùng variable trong request | Postman | 23127211 |
...
## Chi tiết từng kịch bản *(điền dần)*
